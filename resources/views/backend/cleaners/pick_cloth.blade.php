...
<div class="card">
    <div class="card-body">
        <form action='{{ route("backend.$module_name.clothPickup") }}' method="POST" class="form" id="cleanerForm" enctype="multipart/form-data">
            @csrf
            <div class="row mt-4">
                <div class="col">
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12">
                            <label class="form-label col-sm-3">Cloth Count:</label>
                            <span class="col-sm-9">{{$order->cloth_count}}</span>
                        </div>
                        <div class="col-sm-12">
                            <label class="form-label col-sm-3">Cloth Pickup Count:</label>
                            <div class="col-sm-5">
                                <input type="text" name="pick_up_count" id="pick_up_count" value="" class="form-control">
                                <input type="hidden" name="order_id" value="{{$order->id}}">
                            </div>
                            <br>
                            <div class="col-sm-3">
                                <button name="submit" name="picked_up" class="btn btn-primary">Picked Up</button>
                            </div>
                        </div>
                    </div>
                </div>
