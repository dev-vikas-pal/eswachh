    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Eswachh', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
    ...
    'email' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'name' => 'mobile', // unique name for field
                'label' => 'Mobile', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '6394-068-245', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'New Delhi -110096, India', // default value if you want
            ],
        ],
    ...
    'meta' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, web app, Laravel, Eswachh, Bootstrap, Admin, IT solutions, development, web design, secure systems, expert team, 24/7 support, Eswachh', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
