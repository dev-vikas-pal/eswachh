        ...
        <div class="col">
            ...
            <div class="table-responsive">
                <table class="table table-responsive-sm table-hover table-bordered">
                    ...
                    $fieldsToRemove = ['id', 'user_id', 'username', 'gender', 'date_of_birth', 'avatar', 'user_metadata', 'last_ip', 'login_count', 'last_login', 'email_verified_at', 'created_by', 'updated_by', 'deleted_by', 'updated_at', 'deleted_at'];
                    foreach ($all_columns as $key => $object) {
                        if (in_array($object->Field, $fieldsToRemove)) {
                            unset($all_columns[$key]);
                        }
                    }
