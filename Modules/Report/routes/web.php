...
Route::group(['namespace' => '\Modules\Report\Http\Controllers\Backend', 'as' => 'backend.', 'middleware' => ['web', 'auth', 'can:view_backend'], 'prefix' => 'admin'], function () {
    ...
    */
    ...
    Route::get("$module_name/clothReport", ['as' => "$module_name.clothReport", 'uses' => "$controller_name@clothReport"]);
    Route::get("$module_name/clothReportData", ['as' => "$module_name.clothReportData", 'uses' => "$controller_name@clothReportData"]);
