@props(['url', 'name', 'image'=>'', 'rightInfo'=>''])
...
<div class="flex flex-col bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    @endif
    <div class="item service-item rounded-t-lg overflow-hidden">
        <div class="icon">
            <i>
    ...
    <div class="mt-3 px-5">
        <a href="{{$url}}" class="kudisplay">
            <h5 class="mb-2 sm:mb-4 text-lg sm:text-xl font-semibold tracking-tight text-gray-900 kuwidth50">
                {{$name}}
            </h5>
            <h5 class="mb-2 sm:mb-4 text-lg sm:text-xl font-semibold tracking-tight text-gray-900 kuwidth50 kutext-right">
                <!-- {{$rightInfo}} -->
            </h5>
        </a>
    </div>
